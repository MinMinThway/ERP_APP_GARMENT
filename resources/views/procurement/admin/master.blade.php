          ...
          var n = Math.round(d.getTime() / 1000);
            ...
            now.forEach(function(v,i){
              ...
              if (v.status==2) {
                ...
                var body='Plz check order request Sir! staff(procurement)';
              }else if (v.status==4) {
              ...
              if (notforyou) {
                html+=` <li class="nav-item bg-gray">
                          <form id="info${v.id}" action="{{route('order_3_info')}}" method="POST" class="d-none">
                            @csrf
                            @method('GET')
