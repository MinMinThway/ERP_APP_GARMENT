            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li><a href="{{route('finance.admin.home')}}"><i class="fa fa-dashboard pr-2" style="font-size: 20px"></i>Dashboard</a></li>
                </ul>
              </div>
              ...
              <div class="menu_section">
                <h3>Orders</h3>
                <ul class="nav side-menu">
                  <li><a href="{{route('finance.admin.order')}}"><i class="fa fa-inbox pr-2" style="font-size: 20px"></i> Orders Page <span class="label label-success pull-right"></span></a></li>
                    </ul>
              </div>
                  <div class="menu_section">
                <h3>Balance</h3>
            ...
            now.forEach(function(v,i){
              ...
              if (notforyou) {
                html+=` <li class="nav-item bg-gray">
                          <form id="info${v.id}" action="{{route('order_5_info')}}" method="POST" class="d-none">
                            @csrf
                            @method('GET')
